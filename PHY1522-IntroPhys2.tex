...
Lentilles minces : distance focale et puissance [D]
...
\[ G = \frac{\beta}{\alpha}
\approx \frac{y_I/|q|}{y_O/\SI{25}{\centi\metre}} 
\]
...
Diffraction à travers une fente double : maximums d'intensité et largeur de fente
\[ d\sin\theta = m\lambda 
\qquad d = \frac{m\lambda D}{y}
\qquad (m=0,1,2,3,\dots) \]

Diffraction à travers une fente simple : minimums d'intensité et largeur de fente
\[ a\sin\theta = m\lambda 
\qquad a = \frac{m\lambda D}{y}
\qquad (m=1,2,3,\dots) \]
