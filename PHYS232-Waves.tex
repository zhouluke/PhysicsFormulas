...
\begin{itemize}
	\item a constant $\color{\kcol}{k}$ representing the \textcolor{\kcol}{elasticity} of the system $\longrightarrow$ kinetic energy
	\item a constant $\color{\mcol}{m}$ representing the \textcolor{\mcol}{inertia} of the system $\longrightarrow$ potential energy
\end{itemize}

Consider the motion of a mass on a spring, which can be described using...
\begin{align}
	\text{Newton's Law: }&
	\textcolor{\mcol}{m}\ddot{x} + \textcolor{\kcol}{k}x = 0 \label{eqNL} \\
	\text{Conservation of Energy: }&
	\frac{1}{2}\textcolor{\mcol}{m}\dot{x}^2 + \frac{1}{2}\textcolor{\kcol}{k}x^2 = E \label{eqCE}
\end{align}
...
\begin{equation}
\boxed{x = A \cos(\omega t+\alpha)\where\omega^2 = \frac{\color{\kcol}{k}}{\color{\mcol}m}} \label{eqSHMsoln}
\end{equation}
...
\begin{equation}
	\boxed{
		\omega^2 = \frac{\color{\kcol}{\text{elasticity}}}{\color{\mcol}\text{inertia}} \htab\htab 
		T = \frac{2\pi}{\omega} \htab\htab 
		f = \frac{\omega}{2\pi}}
\end{equation}
...
\begin{tabular}{lll}
	...
	Mass on spring &
		$\textcolor{\mcol}{m}\ddot{x} + \textcolor{\kcol}{k}x = 0$ &
		$\dfrac{\color{\kcol}{k}}{\color{\mcol}m}$
		\\
	\parbox{4cm}{Mass on wire \\\footnotesize{(with Young's Modulus $Y$)}} &
		$\textcolor{\mcol}{m}\ddot{x} + \textcolor{\kcol}{\frac{AY}{l_0}}x = 0$ &
		$\dfrac{\color{\kcol}{AY}}{\color{\kcol}{l_0}\color{\mcol}m} = \dfrac{g}{h}$ 
		\\
	Floating objects &
		$\textcolor{\mcol}{m}\ddot{y} + \textcolor{\kcol}{g\rho A}y = 0$ &
		$\dfrac{\color{\kcol}{g\rho A}}{\color{\mcol}m} = \dfrac{g}{h}$ 
		\\
	Torsional oscillations &
		$\textcolor{\mcol}{I}\ddot{\theta} + \textcolor{\kcol}{c}\theta = 0$ &
		$\dfrac{\color{\kcol}{c}}{\color{\mcol}I}$ 
		\\
	\parbox{3.5cm}{Spring of air \\\footnotesize{(isothermal conditions)}} &
		$\textcolor{\mcol}{m}\ddot{y} + \textcolor{\kcol}{\frac{Ap}{l}}y = 0$ &
		$\dfrac{\color{\kcol}{Ap}}{\color{\kcol}{l}\color{\mcol}m}$ 
		\\
	\parbox{3.5cm}{Spring of air \\\footnotesize{(adiabatic conditions)}} &
		$\textcolor{\mcol}{m}\ddot{y} + \textcolor{\kcol}{\frac{A\gamma p}{l}}y = 0$ &
		$\dfrac{\color{\kcol}{A\gamma p}}{\color{\kcol}{l}\color{\mcol}m}$ 
		\\
	\hline
\end{tabular}
...
\begin{center}
	...
	\begin{tabular}[t]{lll}
		...
		Mass on spring &
			$\frac{1}{2}\textcolor{\mcol}{m}\dot{x}^2 + \frac{1}{2}\textcolor{\kcol}{k}x^2 = E $ &
			$\dfrac{\color{\kcol}{k}}{\color{\mcol}m}$
			\\
		Pendulum &
			$\frac{1}{2}\textcolor{\mcol}{I}\dot{\theta}^2 + \frac{1}{2}\textcolor{\kcol}{mgl}\theta^2 = E $ &
			$\dfrac{\color{\kcol}{mgl}}{\color{\mcol}{I}} = \dfrac{\color{\kcol}{mgl}}{\color{\mcol}{ml^2}}= \dfrac{\color{\kcol}{g}}{\color{\mcol}{l}}$ 
			\\
		\parbox{5.5cm}{Pendulum \footnotesize(with radius of gyration $k$, centre of mass at distance $h$ from point of suspension)}&
			$\frac{1}{2}\textcolor{\mcol}{m(k^2+h^2)}\dot{\theta}^2 + \frac{1}{2}\textcolor{\kcol}{mgh}\theta^2 = E $ &
			$\dfrac{\color{\kcol}{gh}}{\color{\mcol}{k^2+h^2}}$ 
			\\
		Water in a U-tube &
			$\frac{1}{2}\textcolor{\mcol}{\rho Al}\dot{y} + \frac{1}{2}\textcolor{\kcol}{(2g\rho A)}y^2 = E$ &
			$\dfrac{\color{\kcol}{2g}}{\color{\mcol}l}$ 
			\\
		Torsional oscillations &
			$\frac{1}{2}\textcolor{\mcol}{I}\dot{\theta} + \frac{1}{2}\textcolor{\kcol}{c}\theta^2 = E$ &
			$\dfrac{\color{\kcol}{c}}{\color{\mcol}I}$ 
			\\
		\parbox{5cm}{Massive springs \\\footnotesize{(with mass $M$)}} &
			$\frac{1}{2}\textcolor{\mcol}{\left(m + \frac{1}{3}M \right)}\dot{x} + \frac{1}{2}\textcolor{\kcol}{k}x^2 = E$ &
			$\dfrac{\color{\kcol}{k}}{\color{\mcol}{m + M/3}}$ 
			\\
		\hline
	\end{tabular}
	\renewcommand{\arraystretch}{1}
...
\begin{align*}
	& -Y = \frac{F/A}{x/l_0} \\
	& \boxed{\therefore F = \textcolor{\kcol}{\frac{-AY}{l_0}} x \label{youngs_F}}
\end{align*}


Once a mass $m$ is hung on one end:
\[ \omega^2 = \sqrt{\frac{\color{\kcol} AY}{\color{\mcol} m \color{\kcol}l_0}} \]
...
\[ \textcolor{\mcol}{m}g=\textcolor{\kcol}{\frac{AY}{l_0}} h \Longrightarrow \frac{ml_0}{AY}=\frac{h}{g} \]
\begin{equation}
\omega^2 = \frac{g}{h}  \label{elWireT}
\end{equation} 
...
\[ \boxed{F_b  = \textcolor{\kcol}{g\rho A}y} \]
...
By Newton's Law:
\[ \textcolor{\mcol}{m}\frac{d^2y}{dt^2} = -\textcolor{\kcol}{g\rho A}y \]
\[ \therefore \omega^2 = \frac{\textcolor{\kcol}{g\rho A}}{\textcolor{\mcol}m} \]
...
\[ \textcolor{\mcol}{m}\cancel{g}=\textcolor{\kcol}{\cancel{g}\rho A} h
\Longrightarrow
h = \frac{m}{\rho A} \]
\[\omega^2 = \frac{g}{h} \]
