...
Hund's Rule & Fill degenerate levels separately w/ spins parallel -- i.e. maximize spin (lower Exchange Energy), minimize e- pairing (Columbic Energy of Repulsion) \\
\end{tabular}
\extraline
...
Transition Metals
\begin{itemize}
\item e- are first removed from orbitals w/ density farthest from nucleus; i.e. from $ns$ before $(n-1)s$
\end{itemize}  
