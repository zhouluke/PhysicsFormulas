...
\eqref{ch3:eq-def-omega-sq} implies that the angular frequency $\omega$, period $T$ and frequency $f$ are \emph{independent of the initial configuration of the system} -- the amplitude $A$ and initial phase $\alpha$!
