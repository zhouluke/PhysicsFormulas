...
\[ \mu_0 = 4\pi\times\SI{ E-7}{H/\meter} \quad [\text{ou }\si{\tesla\cdot\meter/\ampere}] \]
...
\[ c_\text{eau} = \SI{1000}{\kilogram/\meter^3}  \]
...
Équations de continuité (fluides)
\begin{align*}
...
\section{Thermodynamique et les gaz parfaits}

Équation d'état d'un gaz parfait (de $N$ molécules ou $n$ moles)
\[ PV = Nkt = nRT \]

Dilation linéique et volumique
...
Chaleur latente (changements de phrase)
\[ \Delta Q = mL \]

Travail effectué \underline{par un gaz} dans un processus quasi statique (système toujours proche d'un état d'équilibre)
\[ W = \int_{V_i}^{V_f} P\, dV \]
...
Types de processus et travail effectué par un gaz parfait \\
\begin{tabular}{@{\tableindent}lll}
	isobare & $\Delta P=0$  & $W=P\Delta V$  \\
	isochore & $\Delta V=0$  & $W=0$ \\
	isotherme & $\Delta T=0$ & $W=nRT\ln(V_f/V_i)$ \\
...
\[ PV^\gamma = \text{constante} \qquad\quad \gamma = \frac{C_p}{C_v} \]
...
Coefficient d'amplification frigorifique
\[ \text{CAF} = \frac{|Q_f|}{W} \]
