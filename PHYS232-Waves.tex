...
Examine the vertical displacement $y$ of the liquid surface from equilibrium. Define:
\begin{itemize}
...
When liquid \textit{rises} a height of $y$ in one end, the liquid in the other end \textit{sinks} by the same height $y$. The mass of the liquid that moves is $g\rho Ay$. 

Assume all parts of the liquid move with speed $dy/dx$. So,
\[ KE = \frac{1}{2} \left(\frac{dy}{dx}\right)^2 \andd
PE = g\rho Ay^2 \]
