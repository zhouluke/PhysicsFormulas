...
Diffraction à travers une \underline{fente double} : \underline{maximums} d'intensité et distance entre les fentes
\[ d\sin\theta = m\lambda 
\qquad d  \approx \frac{m\lambda L}{y}
\qquad (m=0,1,2,\dots) \]

Diffraction à travers une \underline{fente simple} : \underline{minimums} d'intensité et largeur de fente
\[ a\sin\theta = m\lambda 
