...
Lewis acid & Electroophile (e- pair acceptor) & atoms lacking full octets
\end{tabular}
\extraline
...
\begin{tabular}{@{\tableindent}lp{1.7cm}p{4cm}@{}}
Steric \# & Geometry & Shapes \\ \hline
2 & Linear & Linear \\
3 & Trigonal planar & Trigonal planar, bent / V-shaped \\
4 & Tetrahedral & Tetrahedral, trigonal pyramidal, bent / V-shaped  \\
...
\end{tabular}
\extraline
\tableindent Lone pairs go in positions w/ fewest nearest neighbours
...
\begin{itemize}
\item Central atom: $\uparrow$ size or $\downarrow$ EN = $\downarrow$ e- density on central atom = $\downarrow$ repulsion b/w bonding pairs = $\downarrow$ bond angles
\item Terminal atoms: $\uparrow$ size or $\downarrow$ EN = $\downarrow$ e- density on central atom = $\downarrow$ repulsion b/w bonding pairs = $\downarrow$ bond angles
\end{itemize}

Dipole moments \\
\tableindent Direction: (less EN) $\delta + \rightarrow \delta -$ (more EN)
