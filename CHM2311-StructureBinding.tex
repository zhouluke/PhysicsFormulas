...
\begin{tabular}{@{\tableindent}llp{26mm}@{}}
...
\begin{tabular}{@{\tableindent}lp{2.45cm}p{2.6cm}@{}}
...
\begin{itemize}
	\item Trigonal bipyramidal: LP occupy equatorial slots (so it has 2 axial nearest neighbours, 90° away)
